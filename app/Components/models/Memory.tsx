...
export function Memory(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('models/Cathedral.glb') as unknown as GLTFResult
  return (
    <group {...props} dispose={null}>
      <mesh castShadow receiveShadow geometry={
        nodes['Extract2_04_-_Default_0'].geometry
        } 
        material={
            materials['04_-_Default']
            } 
            scale={0.021} />
      <mesh castShadow receiveShadow geometry={
        nodes.Cylinder006_Ceramic_0.geometry
        } 
        material={
            materials.Ceramic
            } 
